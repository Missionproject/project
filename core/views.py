...
# This method is used to register user or patient in our application 
...
# This method is used to login into the application and also check for valiadtion
...
# This method is used to describe the  patient dashboard
...
# this method is used create a patient profile
...
# This method is used diagnosis the sysmtoms 
...
# this is used to predict the disease on the basis odf 5 symptoms entered by the patient using algorithm.
@csrf_exempt
...
# This method is used show the result of disease which is diagnosis by above method
...
# this method is used to make appointment with the doctor
@csrf_exempt
...
# this method is used to check the status of the appointment
...
# It is a logout session
def logoutView(request):
	logout(request)
	return redirect('login')

# this method describe the doctor dashboard
...
# the template will use the disease variable passed in the context dictionary to display the list of diseases in some way.
...
# this method is used to give appointment to the particular patient and also give the patient a date and time and also recommend
#  them medicine on the basis of disease
@login_required
@csrf_exempt
def MakeMend(request):
  ...
  if sick in disease_list:
      ...
      Medical.objects.filter(pk= disease).update(medicine='Consult to the  Doctor')
      return JsonResponse({'status':'not is store'})


# the function renders the doctor/ment.html template using the context dictionary and 
# returns the rendered template as an HTTP response.
@login_required
...
# it is used the id,date and time to the database and also check if it 	exists
@login_required
@csrf_exempt
